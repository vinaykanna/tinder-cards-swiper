function e({ swiper: e, on: t }) {
  ...
  const d = (e, t) => {
    ...
    l = (t, r) => {
      e.slides.forEach((s, n) => {
        n < e.activeIndex ||
          ((s.style.transformOrigin = t), (s.transformOrigin = r));
      });
    },
    u = (t, r, s, i, o) => {
      if (n || o)
  ...
  t("beforeInit", () => {
    ...
    t("transitionStart", () => {
      a &&
        e.activeIndex !== i &&
        ((a = !1), e.emit("tinderSwipe", c < 0 ? "left" : "right"));
    }),
    t("setTranslate", (t, r) => {
      if ("tinder" !== e.params.effect) return;
      if (s) return;
